...
void drawColon(bool is24Hour) {
  int x = is24Hour ? 155 : 155;                // Kolonpositie (vooruitgedacht op mogelijke aanpassing 12/24h)
...
if (WiFi.status() == WL_CONNECTED && getLocalTime(&timeinfo, 100)) {                                            // Haal lokale tijd op
